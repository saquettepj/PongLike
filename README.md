...
5. **Plataforma de Aceleração** - Ativa aceleração de 30% na bolinha por 10 segundos. Cooldown de 20 segundos (70 🪙)
6. **Reforço** - Plataforma 2x mais alta e destrói bloco de trás (80 🪙)
7. **Tiro Carregado** - Atira projétil perfurante imediatamente (90 🪙)
...
10. **Multi-bola** - Cria uma nova bolinha grudada na plataforma. Cooldown de 1 minuto (120 🪙)
11. **Bolinha Explosiva** - Explode ao atingir tijolos (não afeta o núcleo vermelho) (80 🪙)
12. **Eco da Bolinha** - Destrói um bloco aleatório adicional a cada batida (70 🪙)
13. **Ativador de Efeito** - Ativa efeito aleatório dos blocos na bolinha (cooldown 20s) (110 🪙)
14. **Bolinha Espelhada** - Destrói bloco simétrico ao quebrar um (90 🪙)
15. **Bolinha da Fortuna** - Bolinha dourada que dá +1 moeda por bloco (85 🪙)
...
22. **Conversor de Risco** - Diminui vida do bloco vermelho para 3 e muda velocidade da bolinha entre 80%-140% a cada 5s (120 🪙)
